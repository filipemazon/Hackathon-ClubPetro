		...
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item home_slider_item">
					...
					<div class="home_slider_background" style="background-image:url(public/images/petro.jpg)"></div>
				...
				<!-- Slider Item -->
				<div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(public/images/login.jpg)"></div>
...
<br>
							...
							<input type="text"  class="contact_form_name input_field" placeholder="E-mail" name="email">
							<input type="password"  class="contact_form_name input_field" placeholder="Senha" name="senha">

<br>
  <a href="view\ini\about.php"><button class="form_submit_button button trans_200">Entrar</button></a>
</form>
